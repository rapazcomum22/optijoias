...
<div class="container">
        <div class="well well-sm">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3>Histórico de Ordens de Serviço Cliente: {{$query->nome}}  CPF: {{$query->cpf}}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12 text-center">
            <div class="alert alert-danger alert-dismissible" role="alert">
                ...
                <strong>Cliente: {{$query->nome}}  CPF: {{$query->cpf}} Não possui Ordem de Serviço Cadastrada! Clique Aqui para<a
                            href="{{route('relatorio-cliente-index')}}"> Voltar</a></strong>
            </div>
        </div>
    @endforelse
</div>
